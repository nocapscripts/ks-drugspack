...
Config.RadialMenu = "radialmenu"-- \ The target name (Default: qb-radialmenu)
Config.Inventory = "ox"            -- \ What inventory are you using? ('qb' / 'ox')
...
Config.ZoneDrugs = {            -- \ Names should be same as zone names
    ...
    ["groove"] = {
        { item = 'cokebaggy',    price = math.random(100, 800) },
        { item = 'cannabis',    price = math.random(100, 800) },
        { item = 'marijuana', price = math.random(100, 800) },
        { item = 'meth',         price = math.random(100, 800) },
        { item = 'phone',        price = math.random(100, 200) },
        { item = 'lsd',        price = math.random(100, 500) },
        { item = 'oxy',        price = math.random(100, 500) },
        { item = 'coke_small_brick', price = math.random(100, 500) },
        { item = 'coke_brick', price = math.random(100, 1000) },
    },
    ["vinewood"] = {
        { item = 'cokebaggy',    price = math.random(100, 800) },
        { item = 'cannabis',    price = math.random(100, 800) },
