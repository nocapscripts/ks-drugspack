...
RegisterCommand("maze",function()
    exports['ks-ui']:Maze(function(success)
        if success then
            print("success")
		else
			print("fail")
...
RegisterCommand("var", function()
    exports['ks-ui']:VarHack(function(success)
        if success then
            print("success")
		else
			print("fail")
...
RegisterCommand("circle", function()
    exports['ks-ui']:Circle(function(success)
        if success then
            print("success")
		else
			print("fail")
...
RegisterCommand("thermite", function()
    exports['ks-ui']:Thermite(function(success)
        if success then
            print("success")
		else
			print("fail")
...
RegisterCommand("scrambler", function()
    exports['ks-ui']:Scrambler(function(success)
        if success then
            print("success")
		else
			print("fail")
...
RegisterCommand("display", function()
    exports['ks-ui']:DisplayText("Example Text", "primary") -- Colors: primary, error, success, warning, info, mint
end)

RegisterCommand("hide", function()
    exports['ks-ui']:HideText()
end)
...
RegisterCommand("status", function()
    if not status then
        status = true
        exports['ks-ui']:StatusShow("Area Dominance", {
            "Gang: Ballas",
            "Influence: %100",
        })
    else 
        status = false
        exports['ks-ui']:StatusHide()
    end
end)


RegisterCommand("cmenu", function()
    exports['ks-ui']:CreateMenu({
        {
            header = "header1",
            text = "text1",
...
RegisterCommand("input", function()
    local input = exports['ks-ui']:Input({
        title = "Test",
        inputs = {
            {
                type = "text",
...
RegisterCommand("showimage", function()
    exports['ks-ui']:ShowImage("https://user-images.githubusercontent.com/91661118/168956591-43462c40-e7c2-41af-8282-b2d9b6716771.png")
end)